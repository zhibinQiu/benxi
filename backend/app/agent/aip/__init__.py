"""app.agent.aip — 智能体互操作协议（AIP）精简实现。
...
from app.agent.aip.aid import AidConfig, build_agent_aid, orchestrator_aid, parse_agent_id_from_aid
from app.agent.aip.auth import generate_aip_sk, hash_aip_sk, is_aip_sk_token, sk_display_prefix
...
from app.agent.aip.messaging import (
...
from app.agent.aip.session_bus import AipSessionBus, get_session_bus
from app.agent.aip.types import (
    AipAgentDescription,
    AipCapability,
    AipDataItem,
    AipInteractEnvelope,
