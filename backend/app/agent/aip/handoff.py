...
from app.agent.aip.aid import AidConfig, build_agent_aid, orchestrator_aid
from app.agent.aip.types import AipDataItem, AipMessage, AipMessageType
...
class HandoffBuilder:
    ...
    loop_state_extractors: tuple[Callable[[LoopState], AipDataItem | None], ...] = ()
