...
核心检测逻辑委托 ``app.agent.message``，本层保留平台 AiChatMessage 适配。"""

from __future__ import annotations

from app.agent.message.context import (
...
def is_explicit_greeting_or_chitchat(message: str) -> bool:
    ...
    from app.agent.message.context import is_explicit_greeting_or_chitchat as _check
...
def is_standalone_question(message: str) -> bool:
    ...
    from app.agent.message.context import is_standalone_question as _check
...
def format_conversation_snippet(
    ...
    *,
    ...
    from app.agent.message.context import format_conversation_snippet as _format
