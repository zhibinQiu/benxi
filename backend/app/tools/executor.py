...
from app.tools.errors import ToolErrorCode, is_retryable
from app.tools.rate_limit import check_rate_limit
from app.tools.registry import get_tool_center
from app.tools.schemas import ToolCallRequest, ToolResponse
from app.tools.adapters import run_global_atomic_tool
...
async def execute_tool_call(
    ...
    try:
        ...
        _logger.warning("app.tools execute %s failed: %s", tool_id, exc)
        return _fail(
