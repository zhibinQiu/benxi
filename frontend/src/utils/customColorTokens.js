...
export function buildCustomCssTokens(primaryHex, isDark) {
  ...
  if (isDark) {
    ...
    return {
      ...
      "--platform-glass-depth": `0 10px 29px ${rgba(base, 0.14)}`,
      ...
      "--platform-shadow": `0 2px 10px rgba(0, 0, 0, 0.32), 0 14px 38px ${rgba(base, 0.12)}`,
      "--platform-shadow-sm": "0 1px 4px rgba(0, 0, 0, 0.28)",
      "--platform-shadow-lg": "0 19px 67px rgba(0, 0, 0, 0.52)",
  ...
  return {
    ...
    "--platform-glass-depth": `0 10px 29px ${rgba(base, 0.1)}`,
    ...
    "--platform-shadow": `0 2px 10px ${rgba(base, 0.08)}, 0 10px 29px ${rgba(base, 0.08)}`,
    "--platform-shadow-sm": `0 1px 4px ${rgba(base, 0.06)}`,
    "--platform-shadow-lg": `0 14px 58px ${rgba(base, 0.14)}`,
    "--platform-accent": accent,
    "--platform-accent-hover": accentHover,
    "--platform-accent-pressed": accentPressed,
    "--platform-accent-secondary": accentSecondary,
