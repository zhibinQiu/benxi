...
<template>
  <div class="kg-entity-panel">
    ...
    <n-spin :show="listLoading" class="kg-entity-panel__spin" local>
...
.kg-entity-row-wrap.is-active .kg-entity-row {
  border-color: color-mix(in srgb, var(--platform-primary) 45%, var(--platform-border));
  background: color-mix(in srgb, var(--platform-primary) 10%, var(--platform-bg-elevated));
}
