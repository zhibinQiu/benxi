...
import { smartDataQueryChatStream } from "../api/client";
...
<template>
  <FeatureSubsystemShell fill :show-intro="false">
    <AiChatPanel
      ...
      title="智能问数"
      description="用自然语言查询业务数据，自动生成统计图表与分析洞察，支持多轮追问与深度解读。"
      subtitle="智能问数 · 自然语言分析"
      chat-header-sub="多轮对话 · 当前步骤 · 图表与 Markdown"
