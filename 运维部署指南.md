...
AI 办公系统 = **企业文档与权限控制面** + **PDF 科学文献翻译（BabelDOC）** + **可插拔 AI 能力**（KnowFlow 知识库、会议转写、智能工具等）。
...
# 输出：images/zhitan-4.0.4-amd64.tar.gz
```
...
bash scripts/stack.sh load images/zhitan-4.0.4-amd64.tar.gz
